        ...
        <>
            <div>
                ...
                <div className='mainbg max-w-[1260px] m-auto px-[15px] py-[10px]'>
                    <div className=''>
                        <div>
                            <h1 className='text-[16px] sm:text-[22px] md:text-2xl  text-[#420075] font-bold mb-[10px]'>UTF8 Encoder/Decoder</h1>
                            <p className='text-sm font-normal'>A simple online UTF8 encoder and decoder, for developers and programmers. Simply copy and paste your text in the form field below and see the UTF-8 data on the right.</p>
                        </div>
